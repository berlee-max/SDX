...
export const content = {
  zh: {
    ...
    footer: {
      tagline: 'AI Agent SDX —— 本地优先的桌面 AI 编程工作台',
      columns: [
  ...
  en: {
    hero: {
      title: 'Give your coding agent somewhere you can watch it work',
    ...
    footer: {
      tagline: 'AI Agent SDX — a local-first desktop AI coding workbench',
      columns: [
