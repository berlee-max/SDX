...
Claude Code is Anthropic's command-line coding agent. The engine inside AI Agent SDX is a CLI built from repaired Claude Code sources (it's called `sdx` in this repo), and the desktop app is the graphical shell wrapped around it.
