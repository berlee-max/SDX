...
SDX ships without a model. It's the shell that does the work; you have to give it a brain first.
...
- Leave SDX running for the whole flow — the callback has to land in the running app.
