...
Make sure you're granting the permission to the app that actually launches AI Agent SDX. Screen Recording detection is occasionally unreliable — if the system settings clearly show it granted but the page still says otherwise, it generally works anyway.
...
Confirm you granted them to the app that actually launches AI Agent SDX, fully quit and reopen, then click **Re-check**.
