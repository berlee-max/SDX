...
桌面端跑着的会话，可以接到你手机上的 IM 里。绑定之后，在飞书、Telegram、微信、钉钉、WhatsApp、企业微信、QQ 或 Slack 的私聊里发一句话，就是在驱动本机的 AI Agent SDX：出门前让它跑一个长任务，路上用手机看进度、批权限、换项目。
...
7. 看到配对成功提示后，直接发消息就是在跟 AI Agent SDX 对话。
