...
AI Agent SDX 看着是一个桌面应用，实际是五块可以各自独立运行的代码拼起来的。想读源码或者提 PR，先把这五块的边界分清楚，后面每一篇都会落在其中一块里。
...
![CLI 内核的整体分层](../images/01-overall-architecture.webp)
