...
</head><body><div class="card"><h1>✓ Grok Login Successful</h1><p>Authorization is complete. You can close this window and return to AI Agent SDX.</p></div><script>setTimeout(() => window.close(), 3000)</script></body></html>`
