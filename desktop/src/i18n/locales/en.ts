...
Row 9, all 8 cells: continuing from straight down, turning left through lower-left, left and upper-left, back to near straight up`,
  ...
  'settings.activity.defaultHandle': 'github.com/berlee-max/SDX',
  ...
  'settings.providers.ccSwitch.unavailableSchema': 'This cc-switch version stores its configuration in a layout AI Agent SDX does not recognise yet. Update AI Agent SDX, or add the provider manually.',
  ...
  'settings.agents.description': 'Browse agents available to SDX across built-in, project, and user sources. Use /agents in TUI to inspect active sources and overrides.',
  ...
  'settings.skills.description': 'Skills extend SDX with specialized capabilities. Manage skills in ~/.claude/skills/ or ~/.agents/skills/',
  ...
  'settings.memory.description': 'Inspect and edit the Markdown memory files SDX writes for each project. These files are stored under ~/.claude/projects/<project>/memory/ and are loaded by the CLI runtime.',
  ...
  'settings.computerUse.description': 'Allow SDX to take screenshots, click, type, and control your computer. Requires Python 3. On macOS, accessibility permissions are also needed.',
  'settings.computerUse.enabledToggle': 'Enabled',
  'settings.computerUse.enableRiskTitle': 'Enable Computer Use?',
  'settings.computerUse.enableRiskSummary': 'Computer Use gives SDX broad control of this computer. Only enable it when you understand and accept these risks.',
  'settings.computerUse.enableRiskScreen': 'SDX can take screenshots and may see sensitive or private information on screen.',
  'settings.computerUse.enableRiskActions': 'SDX can click, type, use the clipboard and system shortcuts, and may send, change, or delete content.',
  'settings.computerUse.enableRiskAllApps': 'Once enabled, SDX can control all supported applications without asking for permission app by app. Product safety restrictions still apply.',
  ...
  'settings.computerUse.appsDescription': 'Pre-authorize apps for Computer Use. Authorized apps can be controlled by SDX without runtime prompts.',
  ...
  'settings.computerUse.controlSubtitle': 'Manage how SDX uses other applications on your computer',
  'settings.computerUse.sectionControl': 'Control',
  'settings.computerUse.anyApp': 'Any App',
  'settings.computerUse.anyAppDesc': 'Allow SDX to control apps on your computer',
  'settings.computerUse.osPermTitle': 'System Permissions',
  'settings.computerUse.osPermHint': 'Once enabled, SDX can click, type, and take screenshots on your computer. Your real mouse will not be taken over.',
  ...
  'settings.computerUse.allowedAppsDesc': 'These apps are authorized — SDX can control them directly without confirming each time.',
  ...
  'settings.general.storagePortableDirPlaceholder': 'Choose a folder for AI Agent SDX data',
  ...
  'settings.general.responseLangDescription': 'Instruct SDX to always respond in a specific language.',
  'settings.general.responseLangDefault': 'Default (English)',
  'settings.general.outputStyleTitle': 'Output Style',
  'settings.general.outputStyleDescription': 'Choose how SDX communicates in new or restarted sessions.',
  'settings.general.outputStyleBuiltin.default.label': 'Default',
  'settings.general.outputStyleBuiltin.default.description': 'SDX completes coding tasks efficiently and provides concise responses',
  'settings.general.outputStyleBuiltin.explanatory.label': 'Explanatory',
  'settings.general.outputStyleBuiltin.explanatory.description': 'SDX explains its implementation choices and codebase patterns',
  'settings.general.outputStyleBuiltin.learning.label': 'Learning',
  'settings.general.outputStyleBuiltin.learning.description': 'SDX pauses and asks you to write small pieces of code for hands-on practice',
  ...
  'settings.general.notificationsTestTitle': 'AI Agent SDX notifications are enabled',
  ...
  'empty.subtitle': 'Start a fresh coding session. SDX is ready to help you build, debug, and architect your project.',
  ...
  // ─── Chat Input ──────────────────────────────────────
  'chat.placeholder': 'Ask SDX to edit, debug or explain...',
  ...
  'chat.placeholderQuestionPending': 'Answer the question above first — SDX is waiting on it.',
  ...
  'chat.capabilities.computerUseDescription': 'Let SDX operate apps on this computer',
  ...
  'permission.planPreviewTitle': "SDX's plan",
  ...
  'permission.planFeedbackPlaceholder': 'Tell SDX what to change',
  ...
  // ─── Ask User Question ──────────────────────────────────────
  'question.needsInput': 'SDX needs your input',
  ...
  'question.chatAboutThisHint': 'None of these fit? Hand it back to SDX to follow up — anything already filled in comes along.',
  'question.chatRequested': 'Handed back to SDX, which will follow up',
  'question.chatBadge': 'Handed off',
  'question.expiredBadge': 'Expired',
  'question.expiredNotice': 'This question is no longer waiting for an answer, so sending delivers it to SDX as a new message.',
  ...
  'permMode.autoAcceptDesc': 'SDX writes to disk without asking',
  'permMode.autoMode': 'Auto mode',
  'permMode.autoModeDesc': 'SDX reviews tool calls and runs actions it considers safe',
  ...
  'permMode.enableBypassBody': 'SDX will have <strong>unrestricted</strong> access to execute shell commands and modify files within:',
  ...
  'permMode.enableAutoDetail': 'SDX checks tool calls for risky actions and prompt injection. It runs actions it considers safe and blocks actions it considers risky. Use it only in isolated environments.',
