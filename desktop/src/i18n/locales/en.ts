...
Row 9, all 8 cells: continuing from straight down, turning left through lower-left, left and upper-left, back to near straight up`,
  ...
  'settings.providers.ccSwitch.unavailableSchema': 'This cc-switch version stores its configuration in a layout SDX does not recognise yet. Update SDX, or add the provider manually.',
  ...
  'settings.general.storagePortableDirPlaceholder': 'Choose a folder for SDX data',
