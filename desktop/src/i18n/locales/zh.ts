...
第 9 行 全 8 格：接着上一行，从正下方继续向左转，经过左下、左边、左上，转回接近正上方`,
  ...
  'settings.providers.ccSwitch.unavailableSchema': '当前 cc-switch 版本的配置结构 SDX 尚不认识。请更新 SDX，或手动添加该服务商。',
  ...
  'settings.general.storagePortableDirPlaceholder': '选择一个用于保存 SDX 数据的文件夹',
  ...
  'settings.general.notificationsTestTitle': 'SDX 通知已启用',
