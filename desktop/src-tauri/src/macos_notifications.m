...
bool cchh_send_user_notification(const char *title, const char *body, const char *target, char *error_buffer, uintptr_t error_buffer_len) {
    @autoreleasepool {
        ...
        if (@available(macOS 10.14, *)) {
            ...
            content.title = title != NULL ? [NSString stringWithUTF8String:title] : @"AI Agent SDX";
        ...
        notification.title = title != NULL ? [NSString stringWithUTF8String:title] : @"AI Agent SDX";
        if (body != NULL && strlen(body) > 0) {
